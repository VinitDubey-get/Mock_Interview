        ...
        <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
           <ReactMarkdown
              ...
              components={{
                ...
                table({children}){
                  return(
                    <div className="overflow-x-auto my-4">
                      <div className="min-w-full divide-y divide-gray-300 border border-gray-200">
                        {children}
                      </div>
                    </div>
                  )
                ...
                tbody({children}){
                  return <body className='divide-y divide-gray-200'>{children}</body>
                },
                tr({children}){
...
function CodeBlock({code,language}){
  ...
  return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200 ">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        <button className="text-gray-500 hover:text-gray-700 focus:oultine-none relative group" onClick={copyCode} aria-label='Copy Code'>
          {copied?(
