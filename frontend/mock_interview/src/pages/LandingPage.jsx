...
const LandingPage = () => {
  ...
  return (
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2">
            <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
              Get role-specific questions, expand answers when you need them, dive deeper into concepts, and organize everything your way. From preparation to mastery- your ultimate intervirew toolkit is here.
            </p>
    ...
    <div className='w-full min-h-full relative z-10 '>
      ...
      <div className="w-full min-h-full bg-[#FFFCEF] mt-10 ">
        <div className="container mx-auto px-4 pt-10 pb-20">
          <section className="mt-5">
            <h2 className="text-2xl font-semibold text-center pb-12">
      ...
      <div className='text-sm bg-gray-50 text-secondary text-center p-5 mt-5'>Made for learning... Hapy Coding</div>
