// frontend/src/utils/apiPath.js - Updated version
...
export const API_PATHS = {
  ...
  AI: {
    ...
    END_CONVERSATION: "/api/ai/end-conversation",
  },
  ...
  CONVERSATION: {
    CREATE: "/api/conversations/create", // create new conversation
    GET_ALL: "/api/conversations/my-conversations", // get all user conversations
    GET_ONE: (id) => `/api/conversations/${id}`, // get conversation by id
    ADD_MESSAGE: (id) => `/api/conversations/${id}/message`, // add message to conversation
    COMPLETE: (id) => `/api/conversations/${id}/complete`, // complete conversation with feedback
  },
};