...
const questionAnswerPrompt=(role,experience,topicsToFocus,numberOfQuestions)=>(`
  ...
  const conceptExplainPrompt=(question)=>(`
    ...
    -If the explanation includes a code example, provie a small code block.
   ...
   Important : Do Not add any extra text ourside the JSON format. Only return valid JSON.
